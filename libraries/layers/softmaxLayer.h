...
struct Softmax : Layer
{
    ...
    /**
     * @brief Forward pass through the Softmax activation layer
     * @param input Input matrix
     * @return Output matrix after applying Softmax
     */
    Matrix forward_propagation(const Matrix &input);

    /**
     * @brief Backward pass through the Softmax activation layer
     * @param output_gradient Gradient of the loss with respect to the output
     * @param learning_rate Learning rate (not used in Softmax)
